...
$scope.Data01_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a6","a",6,null);

neoGSheetsLoadCell($App.googleSheet,"a7","a",7,null);

neoGSheetsLoadCell($App.googleSheet,"a8","a",8,null);

neoGSheetsLoadCell($App.googleSheet,"A9","a",9,null);

neoGSheetsLoadCell($App.googleSheet,"a10","a",10,null);
};
...
$scope.AppDev_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a12","a",12,null);

neoGSheetsLoadCell($App.googleSheet,"a22","a",22,null);

neoGSheetsLoadCell($App.googleSheet,"a32","a",32,null);

neoGSheetsLoadCell($App.googleSheet,"a42","a",42,null);

neoGSheetsLoadCell($App.googleSheet,"a52","a",52,null);

neoGSheetsLoadCell($App.googleSheet,"a62","a",62,null);

neoGSheetsLoadCell($App.googleSheet,"a72","a",72,null);

neoGSheetsLoadCell($App.googleSheet,"a82","a",82,null);

neoGSheetsLoadCell($App.googleSheet,"a92","a",92,null);

neoGSheetsLoadCell($App.googleSheet,"a102","a",102,null);

neoGSheetsLoadCell($App.googleSheet,"a103","a",103,null);

neoGSheetsLoadCell($App.googleSheet,"a104","a",104,null);

neoGSheetsLoadCell($App.googleSheet,"a105","a",105,null);

neoGSheetsLoadCell($App.googleSheet,"a106","a",106,null);

neoGSheetsLoadCell($App.googleSheet,"a107","a",107,null);

neoGSheetsLoadCell($App.googleSheet,"a108","a",108,null);

neoGSheetsLoadCell($App.googleSheet,"a109","a",109,null);

neoGSheetsLoadCell($App.googleSheet,"a110","a",110,null);
};
$scope.Appdev2_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a102","a",102,null);
};
$scope.appdev3_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a103","a",103,null);
};
$scope.appdev4_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a104","a",104,null);
};
$scope.appdev5_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a105","a",105,null);
};
$scope.appdev6_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a106","a",106,null);
};
$scope.appdev7_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a107","a",107,null);
};
$scope.appdev8_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a108","a",108,null);
};
$scope.appdev9_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a109","a",109,null);
};
$scope.appdev10_pageenter = function() {neoGSheetsLoadCell($App.googleSheet,"a110","a",110,null);
};
...
$scope.PushButton34_click = function() {$App.googleSheet = "https://docs.google.com/spreadsheets/d/1LfHEbAWtax0i8tx9EZrSqjvVAvYbzHoSOMG2lClHD9w/edit?usp=sharing#gid=X";
...
$scope.PushButton285_click = function() {$scope.GotoPage( "Data01" );};
});
NeoApp.controller("Data01_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 5;
$App.NAB.PageID = "Data01";
$scope.PushButton288_click = function() {$scope.GotoPage( "DBTest" );};
});
...
$scope.PushButton286_click = function() {$scope.GotoPage( "Appdev2" );};
$scope.PushButton287_click = function() {$scope.GotoPage( "appdev3" );};
$scope.PushButton290_click = function() {$scope.GotoPage( "appdev4" );};
$scope.PushButton291_click = function() {$scope.GotoPage( "appdev5" );};
$scope.PushButton292_click = function() {$scope.GotoPage( "appdev6" );};
$scope.PushButton293_click = function() {$scope.GotoPage( "appdev7" );};
$scope.PushButton294_click = function() {$scope.GotoPage( "appdev8" );};
$scope.PushButton295_click = function() {$scope.GotoPage( "appdev9" );};
$scope.PushButton296_click = function() {$scope.GotoPage( "appdev10" );};
});
